...
import SketchField from './../sktech/SketchField';
...
class Detail extends React.Component  {
   ...
   componentDidMount(){
      let position = { top:  100, left: 80, startPoint: 0}
    ...
    render (){
      ...
      return (
          <div className="top-mg-mb">
              ...
              <div  style={{ width: '100%', marginTop: -10, paddingLeft: 12, paddingRight: 12}}>
                      <form>
                            <div className="form-group ">
                              <label for="exampleFormControlTextarea1"></label>
                              <textarea value={this.props.text} className="form-control bgs" placeholder="Write a Story" id="exampleFormControlTextarea1" rows="5" cols="12" ></textarea>
                            </div>
                    </form>
             </div>
          </div>
